...
\begin{figure*}[t]
\centering
\includegraphics[width=0.82\textwidth]{imgs/tcount_comparison.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.88\textwidth]{imgs/zx_splitting_comparison.pdf}
...
\input{tables/tensor_v3_guard_table.tex}
\comment{investigar}
