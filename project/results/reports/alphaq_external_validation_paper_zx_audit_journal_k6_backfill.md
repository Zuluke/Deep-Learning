...
CSV: `results/csv/alphaq_external_validation_paper_zx_audit_journal_k6_backfill.csv`.
...
Rows read: 114.
Rows with local QASM and both detectors OK: 114.
...
| relation | rows |
|---|---:|
| paper-smaller-core | 82 |
| tie | 5 |
| paper-larger-core | 27 |
...
|---|---:|---:|---:|
| depth_guarded_mixed_pair | 9/1/4 | 6/1/7 | 14 |
| t_preserving_frontier_pair | 4/3/1 | 3/3/2 | 8 |

## Largest Paper-Style Core Reductions

| target | objective | materializer | legacy NC depth | paper NC depth |
|---|---|---|---:|---:|
| gf_2pow4_mult | factor_count | selected-shared-parity | 181 | 120 |
| vbe_adder_3 | factor_count | selected-shared-parity | 170 | 119 |
| gf_2pow4_mult | depth_guarded_mixed_pair | selected-shared-parity | 176 | 129 |
| hamming_weight_n7 | factor_count | selected-shared-parity | 117 | 76 |
| gf_2pow4_mult | factor_count | selected-beam-shared-parity-w16 | 153 | 113 |
| hamming_weight_n7 | depth_guarded_mixed_pair | selected-shared-parity | 111 | 71 |
| vbe_adder_3 | factor_count | selected-beam-shared-parity-w16 | 148 | 108 |
| gf_2pow4_mult | depth_guarded_mixed_pair | selected-beam-shared-parity-w4 | 147 | 111 |
