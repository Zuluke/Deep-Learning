...
STUDY_CASES: dict[str, StudyCase] = {
    ...
    "barenco_tof_4": StudyCase(
        target="barenco_tof_4",
        max_action_weight=14,
        objective="mixed-pair",
        candidate_kind="milp_span_mixed_pair_pairo6_wfull",
        factor_order="greedy-cnot",
        target_strategy="max-change",
    ...
    "cuccaro_adder_n4": StudyCase(
        target="cuccaro_adder_n4",
        max_action_weight=12,
        objective="mixed-pair",
        candidate_kind="milp_span_mixed_pair_pairo6_wfull",
        factor_order="greedy-cnot",
        target_strategy="max-change",
    ),
    "gf_2pow4_mult": StudyCase(
        target="gf_2pow4_mult",
        max_action_weight=12,
        objective="mixed-pair",
        candidate_kind="milp_span_mixed_pair_pairo6_wfull",
        factor_order="greedy-cnot",
    ...
    "gf_2pow5_mult": StudyCase(
        target="gf_2pow5_mult",
        max_action_weight=15,
        objective="mixed-pair",
        candidate_kind="milp_span_mixed_pair_pairo6_wfull",
        factor_order="greedy-cnot",
        target_strategy="max-change",
    ...
    "hamming_weight_n7": StudyCase(
        target="hamming_weight_n7",
        max_action_weight=5,
        objective="mixed-pair",
        candidate_kind="milp_span_mixed_pair_pairo6",
        factor_order="given",
